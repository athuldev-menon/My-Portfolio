...
const ContactButton = ({ label = "Contact Me" }) => (
    <Link
        to="/contact"
        className="inline-block text-center rounded-full px-8 py-3 sm:px-10 sm:py-3.5 md:px-12 md:py-4 text-xs sm:text-sm md:text-base text-white font-medium uppercase tracking-widest cursor-pointer hover:scale-105 transition-transform duration-300"
        style={{
...
const ServicesSection = () => {
    const services = [
        ...
        { num: "03", title: "Data Analysis", desc: "Performing exploratory data analysis and generating dynamic visual reports to communicate complex metrics to stakeholders clearly." },
        { num: "04", title: "Digital Marketing", desc: "Executing technical SEO audits, tracking website metrics with GA4, and optimizing digital content for better search engine visibility." }
    ];
